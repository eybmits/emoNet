...
import argparse
import csv
from emonet import emoNet  # Importing the emoNet class from emonet
...
csv_rows = [['filepath', 'anger', 'disgust', 'fear', 'happiness', 'sadness', 'surprise']]
...
for image_name in os.listdir(args.folder_path):
    if image_name.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.tiff')):
        ...
        csv_rows.append([image_path] + rounded_probabilities)

csv_file_path = os.path.join(args.folder_path, 'classification_scores1.csv')

...
directory = '/Users/markusbaumann/emotionrecognition/data/validation_set1'
...
val_transforms = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.5417377352714539], std=[0.23748734593391418])
])
...
model.load_state_dict(torch.load('/Users/markusbaumann/emotionrecognition/output/model82percent.pth'))
model.eval()
...
plt.savefig('/Users/markusbaumann/emotionrecognition/output/confusion_matrix.png')

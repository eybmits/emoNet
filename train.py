...
train_transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    Normalize(mean=[0.5417377352714539], std=[0.23748734593391418])
])
...
print(f"[INFO] Total number of parameters in the model: {total_params}")
...
class_weights = 1. / torch.tensor(list(class_count.values()), dtype=torch.float)
